...
- Binary install is tag-pinned: `bun install -g github:jaypetez/gbrain-copilot#<release-tag>`,
...
- [C1 = D6-A, decided by Garry] **Distribution ref: single `latest-stable` ref.** The
  ...
  block, runbook URL, and `bun install -g github:jaypetez/gbrain-copilot` all
