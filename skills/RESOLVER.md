...
| "connect gbrain to copilot", "copilot mcp", "gbrain in copilot", "copilot can't see my brain", "install the gbrain plugin" | `skills/using-gbrain-with-copilot/SKILL.md` |
