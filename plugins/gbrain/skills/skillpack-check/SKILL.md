...
description: |
  ...
  --list` so a host agent (your agent's morning briefing, any scheduled job)
...
- **Daily cron** (e.g. your agent platform's scheduled `morning-briefing` job): `gbrain skillpack-check --quiet`.
