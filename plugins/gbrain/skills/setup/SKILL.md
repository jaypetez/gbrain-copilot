...
**Agent instructions (always-on platforms - OpenClaw, Hermes, or similar):** Store the Supabase access token in your persistent
...
used the manual install path or an older version of the agent install paste), offer it:
