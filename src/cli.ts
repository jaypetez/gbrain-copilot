...
SETUP
  ...
  doctor [--json] [--fast] [--probe-pglite]  Health check (resolver, skills, pgvector, RLS, embeddings; --probe-pglite runs the scratch-store probe); exit 0=healthy 1=warnings 2=failures
