...
export interface HarnessAdapter {
  ...
  connection: 'codex-toml' | 'claude-json' | 'opencode-json' | 'copilot-json' | 'thin-cli' | 'manual';
  renewable: boolean;
...
const repo = 'https://github.com/jaypetez/gbrain-copilot/blob/main/';
...
export const HARNESS_ADAPTERS: readonly HarnessAdapter[] = [
  ...
  { id: 'copilot', legacyRegister: true, label: 'GitHub Copilot CLI', aliases: ['github-copilot'], modes: ['local-cli', 'stdio', 'http'], connection: 'copilot-json', renewable: false,
    guide: 'docs/mcp/COPILOT_CLI.md', reload: 'Restart Copilot CLI and inspect /mcp.', nativeInstructions: 'existing',
    evidence: dated(['https://docs.github.com/en/copilot/concepts/agents/about-copilot-cli']) },
