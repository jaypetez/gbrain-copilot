...
import { DEFAULT_BRANCH, GITHUB_URL, RAW_BASE_URL } from '../core/repo-coordinates.ts';
 ...
 * stranger's package. */
const VERSION_SOURCE_URL = `${RAW_BASE_URL}/VERSION`;
const RELEASE_NOTES_URL = `${GITHUB_URL}/blob/${DEFAULT_BRANCH}/CHANGELOG.md`;
