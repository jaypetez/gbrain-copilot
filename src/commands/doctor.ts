...
export async function runDoctor(
  ...
  // Use setCliExitVerdict (not process.exit) so cleanup handlers — Bun unload
  // events, open DB connections — still run before the process terminates;
  // process.exit() is a hard kill that bypasses them.
